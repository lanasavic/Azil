...
public class GraphBreedActivity extends AppCompatActivity {
    ...
    private void showChart(ArrayList<BarEntry> dataVals) {
        ...
        String[] breeds = new String[]{"", "Bernski planinski pas", "Jack Russel terijer", "Jazavčar", "Jorkširski terijer", "Koker španijel", "Labrador retriver", "Maltezer", "Mješanac", "Njemački ovčar", "Patuljasti pinč", "Pekinezer", "Zlatni retriver"};
